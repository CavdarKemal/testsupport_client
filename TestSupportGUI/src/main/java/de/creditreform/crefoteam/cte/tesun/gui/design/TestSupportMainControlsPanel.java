...
public class TestSupportMainControlsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        //---- labelEnvironment ----
        labelEnvironment.setText(bundle.getString("TestSupportMainControlsPanel.labelEnvironment.text"));
        ...
        buttonRefreshEnvironment.setActionCommand(bundle.getString("TestSupportMainControlsPanel.buttonRefreshEnvironment.actionCommand"));
        buttonRefreshEnvironment.setToolTipText(bundle.getString("TestSupportMainControlsPanel.buttonRefreshEnvironment.toolTipText"));
        buttonRefreshEnvironment.setText(bundle.getString("TestSupportMainControlsPanel.buttonRefreshEnvironment.text"));
        ...
        buttonManageJVMs.setActionCommand(bundle.getString("TestSupportMainControlsPanel.buttonManageJVMs.actionCommand"));
        buttonManageJVMs.setToolTipText(bundle.getString("TestSupportMainControlsPanel.buttonManageJVMs.toolTipText"));
        buttonManageJVMs.setText(bundle.getString("TestSupportMainControlsPanel.buttonManageJVMs.text"));
        add(buttonManageJVMs, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH,
            new Insets(1, 1, 6, 1), 0, 0));

        //---- labelActivitiHost ----
        labelActivitiHost.setText(bundle.getString("TestSupportMainControlsPanel.labelActivitiHost.text"));
        ...
        labelRestServicesHost.setText(bundle.getString("TestSupportMainControlsPanel.labelRestServicesHost.text"));
        ...
        //---- labelBatchGUIHost ----
        labelBatchGUIHost.setText(bundle.getString("TestSupportMainControlsPanel.labelBatchGUIHost.text"));
        ...
        //---- labelImpCycleHost ----
        labelImpCycleHost.setText(bundle.getString("TestSupportMainControlsPanel.labelImpCycleHost.text"));
        ...
        //---- labelInsoHost ----
        labelInsoHost.setText(bundle.getString("TestSupportMainControlsPanel.labelInsoHost.text"));
        ...
        labelInsoBackEndHost.setText(bundle.getString("TestSupportMainControlsPanel.labelInsoBackEndHost.text"));
