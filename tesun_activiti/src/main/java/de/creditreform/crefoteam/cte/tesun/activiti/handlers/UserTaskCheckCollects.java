...
import de.creditreform.crefoteam.cte.tesun.exports_collector.TestFallCheckCollects;
...
public class UserTaskCheckCollects extends AbstractUserTaskRunnable {
    ...
    public Map<String, Object> runTask(Map<String, Object> taskVariablesMap) throws Exception {
        ...
        doStartTesunClientJob(new TestFallCheckCollects(selectedCustomersMapPhaseX, tesunClientJobListener, testPhase));
