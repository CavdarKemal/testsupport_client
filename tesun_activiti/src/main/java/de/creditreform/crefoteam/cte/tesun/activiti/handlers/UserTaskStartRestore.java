...
import de.creditreform.crefoteam.cte.tesun.restore.TestFallRestoreCrefos;
...
public class UserTaskStartRestore extends AbstractUserTaskRunnable {
    public UserTaskStartRestore(final EnvironmentConfig environmentConfig, TesunClientJobListener tesunClientJobListener) {
    ...
    public Map<String, Object> runTask(Map<String, Object> taskVariablesMap) throws Exception {
        ...
        doStartTesunClientJob(new TestFallRestoreCrefos(selectedCustomersMapPhaseX, testPhase, tesunClientJobListener));
